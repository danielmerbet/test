...
case_study = "ter"
homedir ="/home/dmercado/Documents/NEREIDA/"
os.chdir(homedir)
...
end_date = '2025-06-30' #las day is not complete
...
hourly_dataframe.to_csv(case_study+'/data/meteo/meteo-soil_data_outlet.csv', index=False)
