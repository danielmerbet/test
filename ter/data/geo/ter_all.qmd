...
<qgis version="3.40.8-Bratislava">
  <identifier>HydroBASINS Europe, Level 7, Version 1.c - Sub-basins in IUCN customized format (with lakes)</identifier>
  <parentidentifier></parentidentifier>
  <language></language>
  <type>dataset</type>
  <title>HydroBASINS Europe, Level 7, Version 1.c - Sub-basins in IUCN customized format (with lakes)</title>
  <abstract>All HydroBASINS layers were derived from World Wildlife Fund’s HydroSHEDS data based on a grid resolution of 15 arc-seconds (approximately 500 m at the equator). Watersheds were delineated in a consistent manner at different scales, and a hierarchical sub-basin breakdown was created following the topological concept of the Pfafstetter coding system. The resulting polygon layers are termed HydroBASINS and represent a subset of the HydroSHEDS database. This shapefile contains (sub-)basin polygons for Europe at Pfafstetter level 7.
